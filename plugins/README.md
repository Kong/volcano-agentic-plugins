...
| [`codex`](codex) | Codex | `.codex-plugin/plugin.json` + skills submodule | scaffold |
...
> Cursor, Claude Code, Claude Desktop, and Codex plugins do not copy canonical Volcano skills; they vendor `volcano-skills` as plugin-local `skills` submodules.

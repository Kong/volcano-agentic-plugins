 ...
 *
 * Each scenario feeds the canonical AGENTS.md (read live from
 * sources/volcano-skills/AGENTS.md by the runner) as system context, plus a
...
export const scenarios = [
  {
    ...
    prompt: [
      "Context: `volcano status` shows the CLI is not authenticated. No project is selected.",
      "",
...

  {
    ...
    prompt: [
      "Context: `volcano status` shows the CLI is authenticated. No project is selected.",
      "",
      "User: Build a todo API with `list` and `create` endpoints.",
    ].join("\n"),
    assertions: [
